...
if(BUILD_MOD_PK3)
	...
	foreach(FILE ${ETMAIN_FILES})
		...
		list(APPEND ETMAIN_FILES_REL ${REL})
	endforeach()
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -E tar c ${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}/${MODNAME}_${ETL_CMAKE_VERSION_SHORT}.pk3 --format=zip $<TARGET_FILE_NAME:ui> $<TARGET_FILE_NAME:cgame> ${ETMAIN_FILES_REL}
