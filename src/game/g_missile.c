...
static int flamechunkcnt = 0;
static int flamechunkfrm = 0;
static int flamechunks[50] = {0};
...
void G_RunFlamechunk(gentity_t *ent)
{
	...
	// debugchunk
	// if (flamechunkfrm != level.framenum) {
	// 	int i;
	// 	Com_Printf("; %d:%d (", flamechunkfrm, flamechunkcnt);
	// 	for (i = 0; i < flamechunkcnt; ++i) {
	// 		Com_Printf("%d:", flamechunks[i]);
	// 	}
	// 	Com_Printf(")\n");
	// 	flamechunkcnt = 0;
	// 	flamechunkfrm = level.framenum;
	// 	memset(flamechunks, 0, sizeof(flamechunks));
	// 	flamechunks[flamechunkcnt] = ent->flameQuotaTime;
	// 	flamechunkcnt++;
	// } else {
	// 	flamechunks[flamechunkcnt] = ent->flameQuotaTime;
	// 	flamechunkcnt++;
...
gentity_t *fire_flamechunk(gentity_t *self, vec3_t start, vec3_t dir)
{
	...
	// if (level.time % 100 > 0) {
	// 	bolt->flameQuotaTime   = (((level.time / 100) + 1) * 100) + 50;
	// } else {
	// 	bolt->flameQuotaTime   = (level.time / 100 * 100) + 50;
	// }
	// bolt->flameQuotaTime   = (level.time  + 100) / 100 * 100;
